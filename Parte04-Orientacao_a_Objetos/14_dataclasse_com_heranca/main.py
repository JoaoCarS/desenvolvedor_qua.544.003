...
def main():
    ...
    usuario = PessoaFisica(
        nome="",cpf="",profissao="",idade=0,salario=0.0,
        telefone="",email=""
    )

    empresa = PessoaJuridica(
        razao_social="",nome_fantasia="",cnpj="",
        valor_de_mercado=0.0,telefone="",email=""
    )
    ...
    usuario.salario = float(input("Informe o salário do usuário: R$ ").replace(",","."))
    ...
    empresa.valor_de_mercado = float(input("Informe o valor de mercado da empresa: R$ ").replace(",","."))
